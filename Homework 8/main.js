...
(total > 100) ? document.getElementById("result").innerHTML += "<br>" + "Победа, вы набрали очков " + total : document.getElementById("result").innerHTML += "<br>" + "Вы проиграли, у вас очков " + total;